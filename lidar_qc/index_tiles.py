...
SHEET_WIDTH = 24000  # The width of a 1:50k sheet in metres
SHEET_HEIGHT = 36000  # The height of a 1:50k sheet in metres
SHEET_ORIGIN_LEFT = 988000  # The NZTM x coordinate of the left edge of 1:50k sheet which would be at column position 00
SHEET_ORIGIN_TOP = 6234000  # The NZTM y coordinate of the top edge of sheets in row AS (the northernmost row)
...
class TileBase:
    ...
    def geom(self) -> Polygon:
        return shape(self.feature_geometry())
...
class TileIndex:
    ...
    def __init__(self, scale: TileIndexScale):
        ...
        self.divisions: int = 50000 // scale.value
