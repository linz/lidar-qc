      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" labelPrecision="0" classificationMode="1" clip="0" maximumValue="17" minimumValue="1">
          <colorramp name="[source]" type="gradient">
            <Option type="Map">
              <Option name="color1" value="167,129,149,255" type="QString"/>
              <Option name="color2" value="97,59,78,255" type="QString"/>
              <Option name="direction" value="ccw" type="QString"/>
              <Option name="discrete" value="0" type="QString"/>
              <Option name="rampType" value="gradient" type="QString"/>
              <Option name="spec" value="rgb" type="QString"/>
              <Option name="stops" value="0.25;167,101,135,255;rgb;ccw" type="QString"/>
            </Option>
            <prop v="167,129,149,255" k="color1"/>
            <prop v="97,59,78,255" k="color2"/>
            <prop v="ccw" k="direction"/>
            <prop v="0" k="discrete"/>
            <prop v="gradient" k="rampType"/>
            <prop v="rgb" k="spec"/>
            <prop v="0.25;167,101,135,255;rgb;ccw" k="stops"/>
          </colorramp>
          <item value="1" alpha="255" label="&lt;= 1" color="#a78195"/>
          <item value="5" alpha="255" label="1 - 5" color="#a76587"/>
          <item value="inf" alpha="255" label="> 5" color="#613b4e"/>
