      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" labelPrecision="0" classificationMode="1" clip="0" maximumValue="17" minimumValue="1">
          <colorramp name="[source]" type="gradient">
            <Option type="Map">
              <Option name="color1" value="214,170,156,255" type="QString"/>
              <Option name="color2" value="172,93,51,255" type="QString"/>
              <Option name="direction" value="ccw" type="QString"/>
              <Option name="discrete" value="0" type="QString"/>
              <Option name="rampType" value="gradient" type="QString"/>
              <Option name="spec" value="rgb" type="QString"/>
              <Option name="stops" value="0.25;200,126,92,255;rgb;ccw" type="QString"/>
            </Option>
            <prop v="214,170,156,255" k="color1"/>
            <prop v="172,93,51,255" k="color2"/>
            <prop v="ccw" k="direction"/>
            <prop v="0" k="discrete"/>
            <prop v="gradient" k="rampType"/>
            <prop v="rgb" k="spec"/>
            <prop v="0.25;200,126,92,255;rgb;ccw" k="stops"/>
          </colorramp>
          <item value="1" alpha="255" label="&lt;= 1" color="#d6aa9c"/>
          <item value="5" alpha="255" label="1 - 5" color="#c87e5c"/>
          <item value="inf" alpha="255" label="> 5" color="#ac5d33"/>
